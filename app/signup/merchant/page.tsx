  ...
  return (
    <div className="min-h-screen flex bg-surface">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="absolute inset-0 z-0 bg-gradient-to-tr from-[#556B2F]/10 to-transparent pointer-events-none" />
        ...
        <div className="relative z-10 w-full max-w-md">
                ...
                <form onSubmit={handleSignup} className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 py-3.5 bg-[#556B2F] text-white rounded-xl font-bold hover:bg-[#435525] transition-all shadow-lg disabled:opacity-70 text-lg"
                    >
          ...
          <p className="mt-8 text-center text-sm text-on-surface-variant">
            ...
            <Link href="/login/merchant" className="text-[#556B2F] font-bold hover:underline">
              {t('auth.login')}
            </Link>
          </p>
        </div>
      ...
      {/* Right side: Image */}
      <div className="hidden lg:block w-1/2 relative bg-[#8C5A3B]">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-end p-12 text-white">
          ...
          >
            <h2 className="text-5xl font-black mb-4 leading-tight">Start Selling<br/>Today</h2>
            <p className="text-xl opacity-90 max-w-md">Join Bazaar to reach thousands of customers in your local area.</p>
          </motion.div>
        </div>
      </div>
    </div>
